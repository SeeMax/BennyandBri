...
function theme_header_scripts() {
  if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
    ...
    // wp_register_script('CSSRulePlugin', get_template_directory_uri() . '/js/lib/CSSRulePlugin.min.js', array(), '0.1.3', true);
    // wp_enqueue_script('CSSRulePlugin');

    wp_register_script('MotionPathPlugin', get_template_directory_uri() . '/js/lib/MotionPathPlugin.min.js', array(), '0.1.3', true);
    wp_enqueue_script('MotionPathPlugin');

    // wp_register_script('CustomEase', get_template_directory_uri() . '/js/lib/CustomEase.min.js', array(), '0.6.0', true);
...
function theme_style() {
  wp_enqueue_style( 'google-fonts', "https://fonts.googleapis.com/css?family=Montserrat:300,400,500&display=swap", false );
